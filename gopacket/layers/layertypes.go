...
var (
	...
	LayerTypePPPoETags                    = gopacket.RegisterLayerType(148, gopacket.LayerTypeMetadata{Name: "PPPoETags", Decoder: gopacket.DecodeFunc(decodePPPoETags)})
	LayerTypePPPIPCP                      = gopacket.RegisterLayerType(149, gopacket.LayerTypeMetadata{Name: "PPPIPCP", Decoder: gopacket.DecodeFunc(decodePPPIPCP)})
)
