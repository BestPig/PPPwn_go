...
const (
	...
	PPPLinkControlProtocol             PPPType = 0xc021
	PPPInternetProtocolControlProtocol PPPType = 0x8021
)
...
func initActualTypeData() {
	...
	PPPTypeMetadata[PPPLinkControlProtocol] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodeLCP), Name: "LinkControlProtocol"}
	PPPTypeMetadata[PPPInternetProtocolControlProtocol] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodePPPIPCP), Name: "InternetProtocolControlProtocol"}

	PPPoECodeMetadata[PPPoECodeSession] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodePPP), Name: "PPP"}
	PPPoECodeMetadata[PPPoECodePADI] = EnumMetadata{DecodeWith: gopacket.DecodeFunc(decodePPPoETags), Name: "PPP_Tags"}
